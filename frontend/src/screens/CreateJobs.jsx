...
const CreateJobs = () => {
    ...
    return (
        <div className='flex flex-col px-3 py-2 gap-4 overflow-auto  ' >
            ...
            <div>
                ...
                <input className='outline-none border-2 border-dark-green px-3 py-2 rounded w-[20rem]' value={form.openings} onChange={(e) => setForm({ ...form, openings: e.target.value })} type='number' />
            </div>
            <div>
                <p className='text-lg'>
                    Working Hours
                ...
                <div className='flex flex-row gap-3 ' >
                    <div className='flex flex-col'>
                        ...
                        <input className='outline-none border-2 border-dark-green px-3 py-2 rounded w-[20rem]' onChange={(e) => setMinwh(e.target.value)} type='number' />
                    </div>
                    <div className='flex flex-col'>
                        <p>
                            Max Hours
                        </p>
                        <input className='outline-none border-2 border-dark-green px-3 py-2 rounded w-[20rem]' onChange={(e) => setMaxwh(e.target.value)} type='number' />
                    </div>
                </div>
            </div>
            ...
            <div className='grid grid-cols-1  gap-x-6'>
                ...
                <input type='date' min="1997-01-01" max="2030-12-31" placeholder="dd-mm-yyyy" className='outline-none border-2 border-dark-green px-3 py-2 rounded w-[20rem]' onChange={(e) => setForm({ ...form, startDate: e.target.value })} />
            ...
            <div>
                ...
                <input className='outline-none border-2 border-dark-green px-3 py-2 rounded w-[20rem]' value={form.duration} onChange={(e) => setForm({ ...form, duration: e.target.value })} type='number' />
            </div>
            ...
            <div>
                <p>Apply By</p>
                <input type='date' min="1997-01-01" max="2030-12-31" placeholder="dd-mm-yyyy" className='outline-none border-2 border-dark-green px-3 py-2 rounded w-[20rem]' onChange={(e) => setApplyBy(e.target.value)} />
            </div>
            <div>
                <p>Skills (Must)</p>

                {/* <select className='outline-none border-2 border-dark-green px-3 py-2 rounded w-[20rem]'   onClick={(e)=>}    >
                    {
                        skills.map((item) => {
                            return (
            ...
            <div>
                ...
                <select className='outline-none py-2 bg-white  border-2  border-dark-green   rounded w-[20rem]' onChange={(e) => setForm({ ...form, type: e.target.value })}  >
                    <option value={""}>
                        Chooose Option
                    </option>
            ...
            <div>
                ...
                <select className='outline-none py-2 bg-white  border-2  border-dark-green   rounded w-[20rem]' onChange={(e) => setForm({ ...form, mode: e.target.value })}  >
                    <option value={""}>
                        Chooose Option
                    </option>
                    <option value={"remote"}>
