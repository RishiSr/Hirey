    ...
    return (
        <div className='w-full   flex flex-row'>
            ...
            <div className='b-2 rounded flex flex-col justify-center   gap-8  w-full  place-items-center' >
                ...
                <input className='m-2 mx-10 border-2 rounded py-2 shadow-sm px-2 lg:text-lg -xl:text-base  lg:[29rem]  xl:w-[40rem] ' onChange={(e) => setEmail(e.target.value)} value={email} placeholder='Enter Email' />
                {
                    error.email && <p className='text-red-600 text-bold  mx-10' >{error.email}</p>
                }
                <div className='relative self-center'>

                    <input className='m-2 mx-10 border-2 rounded py-2 shadow-sm px-2 lg:text-lg -xl:text-base   lg:[29rem]  xl:w-[40rem]' type={showPW ? "text" : "password"} onChange={(e) => setPassword(e.target.value)} value={password} placeholder='Enter Password' />
                ...
                <div className='flex flex-row justify-center gap-5'>
                    ...
                    <button className='bg-dark-green text-white  lg:px-10 lg:py-4 -lg:text-sm -lg:p-2 rounded-xl w-fit  self-center active:bg-pale-green' onClick={() => navigate("../recruiter/register")} >
                        Register
                    </button>
                </div>
